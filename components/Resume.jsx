          ...
          <div className="min-h-[40vh] w-full">
            ...
            <TabsContent value="experience" className="w-full">
              <div className="flex flex-col gap-[30px] text-center xl:text-left">
                <h3 className="text-4xl font-bold text-accent-secondary">{experience.title}</h3>
                  ...
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {experience.items.map((item, index) => {
                      return (
                        <li 
                          key={index}
                          className="bg-secondary text-primary h-[184px] py-6 px-10 rounded-xl
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3">
                            {/* dot */}
                            <span className="w-[6px] h-[6px] rounded-full bg-button"></span>
            ...
            <TabsContent value="education" className="w-full">
              <div className="flex flex-col gap-[30px] text-center xl:text-left">
                <h3 className="text-4xl font-bold text-accent-secondary">{education.title}</h3>
                <p className="max-w-[600px] text-secondary mx-auto xl:mx-0">
                    ...
                    return(
                      <li key={index}>
                        <TooltipProvider delayDuration={100}>
                          <Tooltip>
                            <TooltipTrigger 
                              className="w-full h-[150px] bg-accent-secondary rounded-xl flex
                  ...
                  {about.info.map((item, index) => {
                    return (
                      <li key={index} className="flex items-center justify-center xl:justify-start gap-4">
                        <span className="text-accent-secondary">{item.fieldName}</span>
