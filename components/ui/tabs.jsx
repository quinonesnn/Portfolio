...
const TabsTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "text-primary bg-secondary ring-offset-white data-[state=active]:bg-button data-[state=active]:text-primary inline-flex items-center w-full  justify-center whitespace-nowrap rounded-lg p-3 text-base font-medium transition-all disabled:pointer-events-none disabled:opacity-50 data-[state=active]:font-bold data-[state=active]:shadow-sm",
      className
    )}
    {...props} />
))
