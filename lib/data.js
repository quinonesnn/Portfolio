...
export const resume = [
  ...
  },
  {
    ...
    location: "Orlando, FL",
    description:[
      "Collaborated with cross-functional teams to troubleshoot complex technical issues, manage development tickets, and ensure proper communication within a fast-paced software development environment.",
      "Implemented a now-integrated custom Python application for my team that streamlined the onboarding formatting process. This significantly reduced the time needed to process these frequently occurring cases by 50%.",
      "Documented front-end and back-end application issues from first-hand users for the iAssist platform in detail, leveraging my expertise in full-stack development to understand the internal infrastructure of our application."
    ],
    icon: <FaComputer />,
    date: "2023 - present",
  },
